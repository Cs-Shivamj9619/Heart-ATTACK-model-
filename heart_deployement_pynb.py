...
Heart_Rate= st.number_input("Heart_Rate",min_value=0,max_value=220)
Systolic_Blood_Pressure= st.number_input("Systolic_Blood_Pressure",min_value=0,max_value=300)
